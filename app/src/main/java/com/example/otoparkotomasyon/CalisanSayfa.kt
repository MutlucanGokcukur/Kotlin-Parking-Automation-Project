...
import kotlinx.android.synthetic.main.activity_calisan_sayfa.*
import kotlinx.android.synthetic.main.activity_personel_sayfa.*

class CalisanSayfa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LstCalisanSayfa.onItemClickListener=
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.calisanmenu,menu)
        return super.onCreateOptionsMenu(menu)
    }

    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if(item.itemId==R.id.odemeler)
        {
        ...
        else if(item.itemId==R.id.bilgiguncelle)
        {
            val intent=Intent(applicationContext,CalisanBilgiGuncelle::class.java)
